...
if __name__ == '__main__':
    ...
    optimizer = pruning.NAGSparse(wd=1e-5, lr_scheduler=lr_scheduler, target_sparsity=target_sparsity, pretrain_step=pretrain_step, sparse_step=sparse_step, frequency=frequency, keywords_no_sparse=keywords_no_sparse, special_sparsity_dict=special_sparsity_dict)
    print('*** pruning setup ***')
    ...
    print("*** model saved as mxnet_mnist ***")
